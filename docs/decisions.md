...
| 4 | 2026-09-05 | **edge-beeb's copy** becomes a verbatim copy in its `lib/`, the same treatment as `lib/vgiplayer.asm`. This library is upstream; edge-beeb never edits it. **Not done yet** — see `PLAN.md`. |
